...
MORDOR_UNITTEST(String, sha1sum)
{
    MORDOR_TEST_ASSERT_EQUAL(hexstringFromData(sha1sum("")), "da39a3ee5e6b4b0d3255bfef95601890afd80709");
    MORDOR_TEST_ASSERT_EQUAL(hexstringFromData(sha1sum("1234567890")), "01b307acba4f54f55aafc33bb06bbbf6ca803e9a");
